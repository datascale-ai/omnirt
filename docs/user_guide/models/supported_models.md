...
<!-- registry_hash: 2ee06e86d14174213ee6ecae9bd01e41b1b8b9e907e110dcda25d1677a419c60 -->
...
| Registry id | Task | Tier | Maturity | Realtime | Summary |
|---|---|---|---|---|---|
| `cosyvoice3-triton-trtllm` | `text2audio` | core | beta | no | CosyVoice3 text-to-audio generation through a CUDA Triton/TensorRT-LLM service endpoint. |
...
| `vllm-omni-speech` | `text2audio` | core | beta | no | vLLM-Omni OpenAI-compatible speech generation through /v1/audio/speech. |
